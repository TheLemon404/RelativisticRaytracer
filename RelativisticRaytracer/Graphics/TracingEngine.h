...
struct GravityBodyBuffer
{
	GravityBody gravityBodies[1];
};
...
private:
	...
	static void UploadGravityBodies();
...
public:
	inline static std::vector<GravityBody> gravityBodies;
